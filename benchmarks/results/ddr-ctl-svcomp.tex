bresenham1-nla-invalid.c & \rFALSE  & \rTRUE   & 192.8    & Rand;UC;ExN1  & $\ell_{36}:exact:((((((((2   Y)   x) - ((2   X)   y)) - X) + (2   Y)) - v) + c) <= k);(0 >= (c - k)):(((0 + (k   1)) + (c   -1)) <= -1):$  \\
...
dijkstra5-both-t.c & \rTRUE   & \rUNK    & \rUNK    & Rand;UC; &  \\
...
ps3-nla-valid.c & \rTRUE   & \rUNK    & \rUNK    & Rand;UC; &  \\
