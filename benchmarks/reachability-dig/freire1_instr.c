...
#include "stdlib.h"
void vtrace_else_28(double a , int r , double x ) 
{ 
...
void vtrace_if_28(double a , int r , double x ) 
{ 
...
int ( /* missing proto */  reach_error)(void) 
{ 
...
{ 
  ...
  r = 0;
  while (1) {
    if ((int )((((double )(r * r) - a) - (double )r) + (double )2 * x) != 0) {
      vtrace_if_28(a, r, x);
      reach_error();
    } else {
      vtrace_else_28(a, r, x);
    }
    if (! (x > (double )r)) {
      break;
    }
