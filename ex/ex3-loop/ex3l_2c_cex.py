...
[L355]              int x ;
[L356]              int y ;
[L357]              int if_too_small_4 ;
[L358]              int else_too_big_4 ;
[L359]              int else_too_small_4 ;
[L360]              int if_too_big_4 ;
[L363]  COND TRUE   1
[L364]  COND FALSE  !(x * y < 0)
        VAL         [x=1, y=0]
[L374]  COND TRUE   ! (x <= 0 && y <= 0)
[L375]              if_too_big_4 = 1
        VAL         [if_too_big_4=1, x=1, y=0]
[L376]              reach_error()
        VAL         [if_too_big_4=1, x=1, y=0]
"""
