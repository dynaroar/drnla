...
#include "stdlib.h"
void vtrace(int k , int n , int x , int y , int z ) 
{ 
...
void vtrace_else_8(int k , int n , int x , int y , int z ) 
{ 
...
void vtrace_if_8(int k , int n , int x , int y , int z ) 
{ 
...
{ 
  ...
  while (1) {
   //  vtrace(k, n, x, y, z);
    if (((3 * n) * n + 3 * n) + 1 <= k) {
      vtrace_if_8(k, n, x, y, z);
    } else {
      vtrace_else_8(k, n, x, y, z);
      break;
    }
    n ++;
    x += y;
